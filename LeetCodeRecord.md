...
> <p style="color:red"><b> 上个星期说是复习数据结构，但也没好好看，来道中等的数据结构吧</b></p>
>
> 1. **`题目1—— leetcode剑指offer36 二叉搜索树与双向链表（Medium）`**
### 4.11 Day12

> <p style="color:red"><b> pzx布置题那就是主打一个偷懒。。。</b></p>
>
> 1. **`题目1—— leetcode837 新21点 ( Medium )`**
### 4.12 Day13
> <p style="color:red"><b>不知道前两天的你完成了没，怎么感觉你被我传染偷懒了，今天布置简单的，把前两天进度补上</b></p>

> 1. **`题目1—— leetcode70 爬楼梯（Easy）`**
### 4.13 Day14
...
> **LeetCode 75题单中（数组/字符串专题中的Medium）**
>
> 1. **`反转字符串中的单词`**
> 2. **`除自身以外数组的乘积`**
...
> **LeetCode 75题单中（双指针专题中的Easy+Medium）**
>
> 1. **`移动零`**
> 2. **`判断子序列`**
> 3. **`盛水最多的容器`**
...
> **LeetCode 75题单中（滑动窗口专题中的Easy+Medium）**
>
> 1. **`子数组最大平均数 I`**
> 2. **`定长子串中元音的最大数目`**
...
> **是不是觉得被我布置题目支配的周很恐怖, 哈哈哈哈哈, 大学牲就该这么辛苦,呜呜呜**
...
由于某种原因，中途中断了一段时间，现在我们又回来啦，好习惯不能不坚持！

**<font color="red">另外对于新回归做以下说明</font>**

> 1. 之前合作伙伴表示任务太重，所以新的规则修改成了**每天刷一道题**，自己选择题目（为了让大家能养成习惯，而不是感到压力😀
> 2. 由于1规则的修改，此后这个文档不再更新 😛
...
###  4.24 Day 22
> **出题权回到了摆烂人手里**
> **LeetCode 75题单中（哈希表专题 M）**
>
> 1. **`1657.确定两个字符串是否接近`**
>>>>>>> fca83251af6921f12989db6a7d19add12e67ea1f
